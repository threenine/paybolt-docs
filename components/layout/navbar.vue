      ...
      <div class="relative flex h-16 items-center justify-between">
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          <DisclosureButton
            ...
            <Icon name="heroicons-solid:x-mark" v-else class="block h-6 w-6" aria-hidden="true"/>
          </DisclosureButton>
        </div>
        ...
        <div class="lg:flex flex-grow items-center">
          <ul class="flex flex-col lg:flex-row list-none ml-auto">
            ...
            <li class="nav-item p-3">
              <a href="https://github.com/threenine/paybolt" target="_blank"
                 class="flex items-center text-sm font-medium dark:text-gray-100 text-gray-900  hover:text-white">
                <Icon name="uil:github" class="theme-icon text-typography_primary_light dark:text-typography_primary_dark text-3xl"/>
              </a>
            </li>
          </ul>
        </div>
